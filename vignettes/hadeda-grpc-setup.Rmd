...
crypto_stubs <- hadeda_read_services2(file.path(proto_root, "services", "crypto_service.proto"))
network_stubs <- hadeda_read_services2(file.path(proto_root, "services", "network_service.proto"))
```
