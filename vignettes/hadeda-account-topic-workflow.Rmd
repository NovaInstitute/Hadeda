...
Persist the private key securely if you plan to reuse this account later—`keyring` can store it under a descriptive service
...
new_account <- hadeda_crypto_create_account(
  public_key      = pub_key,
...
new_topic <- hadeda_consensus_create_topic(
...
Topics can be further customized by specifying admin or submit keys. Refer to `?hadeda_consensus_create_topic` for the full argument set.
